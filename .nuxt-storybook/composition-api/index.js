...
const ssrValue = (value, key) => {
  ...
  if (process.client) {
    ...
    return (_d = (_c = (_b = window[globalContext]) == null ? void 0 : _b.ssrRefs) == null ? void 0 : _c[key]) != null ? _d : getValue(value);
  }
  return getValue(value);
};
...
const staticPath = "/Users/krutipatel/Teach-Nuxt/infinite-masonry-layout-with-nuxt/.nuxt-storybook/static-json";
const staticCache = {};
